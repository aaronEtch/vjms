...
class Members extends CI_Controller 
{
	...
	{
		//intending to use a constructor			
		parent::__construct();
	//	$this->is_logged_in();
	    //
...
//	}
	...
	// set value to user object (ion auth) - ttp://benedmunds.com/ion_auth/
	$theUserId = $user->id;
	$data['userIdNumber'] = $theUserId;
	
	$this->load->model('list_view');
	// main list of wines
	$data['rows'] = $this->list_view->getList($theUserId);
	// for auto suggest
	...
	function create (){
		...
		// model auto loaded
		//$this->detail_view->addRecord($data);
		redirect('members/detail_view/'.$data['wineId']);
