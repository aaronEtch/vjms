...
* @return    integer
*/
function mysqldatetime_to_date($datetime = "", $format = "m/d/Y")
{
    return date($format, mysqldatetime_to_timestamp($datetime));
}

/**    option $format = "d.m.Y, H:i:s"
...
* @param     string
* @return    string
 * aa here, changing this $format = "d/m/Y H:i:s" to this $format = "m/d/Y H:i:s"
*/
...
// switched $hour, $min, $sec,  $month, $day, $year);
